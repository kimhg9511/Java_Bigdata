...
<body>
    ...
    <div class="view">
        <table>
            ...
            <tr class="contents">
                <td colspan="4"><textarea name="" id="" cols="30" rows="30"disabled>게시글</textarea></td>
            </tr>
            <tr>
    ...
    <div class="button tail">
        <input type="button" value="목록" onclick="location.href='../index1.jsp'">
        <input type="button" value="수정" onclick="location.href='update.jsp'">
        <input type="button" value="답변" onclick="location.href='update.jsp'">
