...
<body>
	<div class="input form center">
		...
		<form action="/bigdata/join/joinOk.jsp" method="POST" name="form">
			<div class="idpass">
				<h2>사이트 이용정보 입력</h2>
				<span>아이디</span><input type="text" name="uid" id="uid" value="아이디"><br>
				<span class="notice">영문자, 숫자, _만 입력 가능. 최소 3자이상 입력하세요.</span><br>
				<span>비밀번호</span><input type="text" name="upw" id="upw" value="비밀번호"><br>
				<span>비밀번호확인</span><input type="text" name="repw" id="repw" value="비밀번호확인"><br>
			</div>
			<div class="private">
				<h2>개인정보 입력</h2>
				<span>닉네임</span><input type="text" name="nick" id="nick" value="닉네임"><br>
				<span class="notice">공백없이 한글, 영문, 숫자만 입력 가능(한글2자, 영문4자
					이상)닉네임을 바꾸시면 앞으로 60일 이내에는 변경할 수 없습니다.</span><br> <span>이름</span><input
					type="text" name="name" id="name" value="이름"><br> <span>email</span><input
					type="text" name="email" id="email" value="email"><br>
			</div>
			<div class="button">
