...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<form action="replyOk.board" method="post" name="form">
	<div class="write form">
		...
		<h2>제목</h2>
		<input id="btitle" type="text" name="showtitle" value="Re:${board.title }" readonly><br>
		<input type="hidden" name="title" value="Re:${board.title }">
		<h2>내용</h2>
		<textarea id="bcontent" cols="30" rows="10" name="content"></textarea>
		<textarea id="bcontent" cols="30" rows="10" name="content2" disabled>${board.content }</textarea>
		<br>
		<div class="tail">
			<h2>비밀번호</h2>
